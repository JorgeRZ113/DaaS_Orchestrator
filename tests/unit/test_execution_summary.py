"""Construccion del resumen legible a partir de la telemetria en memoria.

Es unitaria: `telemetry.observe_duration` solo acumula en memoria y ni el
`build_execution_summary` ni el render de markdown tocan disco ni red. La
comprobacion del endpoint que lo expone vive en `tests/api/test_summary_endpoint.py`.
"""
