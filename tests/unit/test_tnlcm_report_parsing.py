"""Parseo del report Markdown que devuelve TNLCM.

El report es texto libre con secciones; de el salen la URL de ELCM y el
resumen que consumen las fases posteriores. Es logica pura sobre una cadena:
ni red ni disco, aunque el codigo viva en el adaptador.
"""
