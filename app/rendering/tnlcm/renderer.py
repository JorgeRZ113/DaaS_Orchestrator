...
from app.storage import artifacts as artifacts_module
from app.domain.descriptor import InfrastructureConfig
from app.rendering.tnlcm.overlay import (
    build_component_overlay_values,
    InvalidDatasetDescriptorError,
...
async def generate_tnlcm_descriptor(
    ...
    Raises:
        ...
        InvalidDatasetDescriptorError: Si hay campos no permitidos
    ...
    for comp_key in component_order:
        ...
        try:
            ...
            raise
        except InvalidDatasetDescriptorError as e:
