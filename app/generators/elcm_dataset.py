...
Separado a propósito del pipeline TNLCM (`app/generators/tnlcm_*.py`). Igual que
...
from app.utils.ytt_renderer import run_ytt_cli, templates_root_dir
...
def _resolve_dataset_assets(kind: str) -> tuple[Path, Path]:
    """
...
async def generate_elcm_dataset_testcase(
    ...
    """
    template_path, overlay_path = _resolve_dataset_assets(kind)
